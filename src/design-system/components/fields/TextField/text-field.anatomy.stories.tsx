...
const meta: Meta = {
  title: 'Design System/Components/Fields/TextField/設計規格',
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="border-t border-divider pt-2 mt-1 flex flex-col gap-2">
          ...
          <div className="flex items-center gap-4">
            <div className="w-64 shrink-0">
              <TextField error defaultValue="invalid-email@" size="md" />
            </div>
            ...
            <tbody>
              {(['readonly', 'disabled'] as const).map((m) => (
                <tr key={m}>
                  ...
                  <td className="p-3 border-b border-divider align-top min-w-[240px]">
                    <TextField mode={m} defaultValue="Wireless Bluetooth Headphones" size="md" />
                  </td>
                  <td className="p-3 border-b border-divider align-top">
                ...
                <tr key={sz}>
                  ...
                  {MODES.map((m) => (
                    <td key={m} className="p-2 border-b border-divider">
                      <TextField mode={m} size={sz} defaultValue="Headphones" className="w-48" />
                    </td>
                  ))}
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2 max-w-sm">
            ...
            <TextField placeholder="點擊或 Tab 觀察 focus 邊框" />
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3 max-w-sm">
            ...
            <div>
              ...
              <TextField error defaultValue="bad-url" startIcon={Search} />
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3 max-w-sm">
            <div className="flex items-center gap-3">
              <TextField mode="edit" startIcon={Mail} defaultValue="alice@example.com"
                endAction={{ icon: X, label: '清除', onClick: () => {} }} className="w-56" />
              <span className="text-fg-muted text-caption">→</span>
              <TextField mode="disabled" startIcon={Mail} defaultValue="alice@example.com"
                endAction={{ icon: X, label: '清除', onClick: () => {} }} className="w-56" />
            </div>
