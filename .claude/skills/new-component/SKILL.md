...
**Mandatory**。chain `/component-quality-gate` 走 45 項 checklist + Phase 4.5 visual audit(Layer A + B)。對齊 CLAUDE.md 稽核三級 Tier 1 stakeholder-gate:元件要 merge 前 code + visual 雙層過關。
