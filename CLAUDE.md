...
## 3 題判斷 + 規則 + 世界級對照 → `.claude/references/primitive-exposure.md`

**快速判斷**:Q1 app 要 import 嗎 → L1 / Q2 host 內 embedded config? → L2 / Q3 建新 host 的 building block? → L3 / 都不是 → 不該是新 primitive。新 L1 走 Checkpoint 3;L2/L3 可 AUTO。
