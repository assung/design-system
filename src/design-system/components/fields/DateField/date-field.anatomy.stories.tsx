...
const meta: Meta = {
  title: 'Design System/Components/Fields/DateField/設計規格',
      ...
      <div className="flex flex-col gap-3">
          ...
          {MODES.map((m) => (
            <div key={m} className="flex items-center gap-4">
              <div className="w-64 shrink-0">
                <DateField mode={m} value="2026-04-02" onChange={() => {}} />
              </div>
        ...
        <div className="border-t border-divider pt-2 mt-1 flex flex-col gap-2">
          ...
          <div className="flex items-center gap-4">
            <div className="w-64 shrink-0">
              <DateField error value="2026-04-02" onChange={() => {}} />
            </div>
            ...
            <tbody>
              {(['readonly', 'disabled'] as const).map((m) => (
                <tr key={m}>
                  ...
                  <td className="p-3 border-b border-divider align-top min-w-[240px]">
                    <DateField mode={m} value="2026-04-02" />
                  </td>
                  <td className="p-3 border-b border-divider align-top">
                ...
                <tr key={sz}>
                  ...
                  {MODES.map((m) => (
                    <td key={m} className="p-2 border-b border-divider">
                      <DateField mode={m} size={sz} value="2026-04-02" onChange={() => {}} className="w-48" />
                    </td>
                  ))}
                  <td className="p-2 border-b border-divider">
                    <DateField size={sz} value="2026-04-02" onChange={() => {}} clearable className="w-48" />
                  </td>
                </tr>
              ))}
            </tbody>
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3 max-w-sm">
            ...
            <DateField value={clearVal} onChange={setClearVal} clearable />
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex items-center gap-3">
              <DateField value="2026-04-02" onChange={() => {}} clearable className="w-56" />
              <span className="text-fg-muted text-caption">→</span>
              <DateField mode="readonly" value="2026-04-02" className="w-56" />
              <span className="text-fg-muted text-caption">→</span>
              <DateField mode="disabled" value="2026-04-02" className="w-56" />
            </div>
          ...
          <div className="overflow-x-auto">
            <table className="border-collapse text-caption">
              ...
              <tbody>
                <tr>
                  <Td>預設（MM/DD/YYYY）</Td>
                  <td className="p-2 border-b border-divider"><DateField mode="readonly" value="2026-04-02" /></td>
                  <td className="p-2 border-b border-divider"><DateFieldDisplay value="2026-04-02" /></td>
                </tr>
                <tr>
                  <Td mono>month: 'short'</Td>
                  <td className="p-2 border-b border-divider">
                    <DateField mode="readonly" value="2026-04-02" formatOptions={{ year: 'numeric', month: 'short', day: 'numeric' }} />
                  </td>
                  <td className="p-2 border-b border-divider">
                    <DateFieldDisplay value="2026-04-02" formatOptions={{ year: 'numeric', month: 'short', day: 'numeric' }} />
                  </td>
                </tr>
                <tr>
                  <Td mono>month: 'long'</Td>
                  <td className="p-2 border-b border-divider">
                    <DateField mode="readonly" value="2026-04-02" formatOptions={{ year: 'numeric', month: 'long', day: 'numeric' }} />
                  </td>
                  <td className="p-2 border-b border-divider">
                ...
                <tr>
                  ...
                  <td className="p-2 border-b border-divider">
                    <DateField mode="readonly" value="2026-04-02" locale="zh-TW" formatOptions={{ year: 'numeric', month: 'long', day: 'numeric' }} />
                  </td>
                  <td className="p-2 border-b border-divider">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex items-center gap-3">
              ...
              <DateField mode="readonly" value={null} className="w-48" />
            </div>
            <div className="flex items-center gap-3">
              <span className="text-[11px] text-fg-muted w-20 shrink-0">disabled</span>
              <DateField mode="disabled" value={null} className="w-48" />
            </div>
            <div className="flex items-center gap-3">
