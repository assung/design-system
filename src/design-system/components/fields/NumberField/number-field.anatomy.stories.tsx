...
const meta: Meta = {
  title: 'Design System/Components/Fields/NumberField/設計規格',
    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-4">
        <div className="flex flex-col gap-1">
          <H3>結構（Anatomy）</H3>
          <Desc>NumberField 由 wrapper + input + 可選 endAction 組成。edit 模式輸入 raw 數值，readonly / disabled 顯示格式化結果。</Desc>
        </div>
          ...
          {MODES.map((m) => (
            <div key={m} className="flex items-center gap-4">
              <div className="w-56 shrink-0">
                <NumberField mode={m} value={2490} prefix="$" className="max-w-[200px]" />
              </div>
      ...
      <div className="flex flex-col gap-3">
        <H3>格式化選項</H3>
        <Desc>格式化在 readonly / disabled 和 NumberFieldDisplay 生效。edit 模式輸入 raw 數值（不套格式），確保使用者能直覺地修改。</Desc>
        <div className="flex flex-col gap-2">
          {([
            ...
            <div key={label} className="flex items-center gap-4">
              <div className="w-56 shrink-0">
                <NumberField mode="readonly" value={value} {...props} className="max-w-[200px]" />
              </div>
                  ...
                  <tr key={st}>
                    ...
                    <Td>
                      <div className="w-[180px]">
                        <NumberField mode="edit" value={2490} prefix="$" error={st === 'error'} />
                      </div>
                    </Td>
              ...
              {(['readonly', 'disabled'] as ModeKey[]).map((m) => {
                ...
                return (
                  <tr key={m}>
                    ...
                    <Td>
                      <div className="w-[180px]">
                        <NumberField mode={m} value={2490} prefix="$" />
                      </div>
                    </Td>
                    <Td><span className="inline-flex items-center gap-1.5"><Swatch value={c.bg} size="sm" /><span className="font-mono text-[11px]">{c.bg}</span></span></Td>
                    <Td><span className="inline-flex items-center gap-1.5"><Swatch value={c.text} size="sm" /><span className="font-mono text-[11px]">{c.text}</span></span></Td>
              ...
              {MODES.map((m) => (
                <tr key={m}>
                  ...
                  {SIZES.map((sz) => (
                    <Td key={sz}>
                      <div className="w-[180px]">
                        <NumberField mode={m} size={sz} value={2490} prefix="$" />
                      </div>
                    </Td>
                  ))}
                </tr>
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center gap-4">
            <div className="w-[200px]">
              <NumberField value={focusValue} onChange={setFocusValue} prefix="$" placeholder="點擊 focus" />
            </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex items-center gap-4">
              <div className="w-[200px]">
                <NumberField value={-100} error prefix="$" />
              </div>
              <span className="text-[11px] text-fg-muted">edit + error: border-error + aria-invalid</span>
            </div>
            <div className="flex items-center gap-4">
              <div className="w-[200px]">
                <NumberField mode="readonly" value={-100} error prefix="$" />
              </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center gap-4">
              <div className="w-[200px]">
                <NumberField mode="readonly" value={1500} prefix="$" />
              </div>
          ...
          <div className="flex items-center gap-6">
            {(['edit', 'readonly', 'disabled'] as const).map((m) => (
              <div key={m} className="flex flex-col gap-1 items-start">
                ...
                <div className="w-[160px]"><NumberField mode={m} value={null} prefix="$" /></div>
